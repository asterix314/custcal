/********************************************
    ...
    流通类型：  00
********************************************/
if exists (select * from sysobjects where type='P' and name='sp_Cust_RZRQ_Chrzfzbj')
    drop proc sp_Cust_RZRQ_Chrzfzbj
go
/*
exec sp_Cust_RZRQ_Chrzfzbj  20150105, 1, 100, @msg output
select @msg
*/
CREATE proc sp_Cust_RZRQ_Chrzfzbj(
 @serverid  int
,@bizdate   int
,@sno       int
,@custid    bigint
